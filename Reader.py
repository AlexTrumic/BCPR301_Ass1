...
class Reader():
    ...
    def csv_reader(self, file_Location):
        ...
        try:
            ...
            while(valid == True):
                ...
                try:
                    employee.my_empid = my_cleaner.clean_empid(employee.my_empid)
                    if my_validator.val_empid(employee.my_empid, employee.my_empid) != True:
                        valid = False
                    elif my_validator.Validate_Age(employee.my_age) != True:
                        valid = False
                    elif my_validator.Validate_Birthday(employee.my_birthday, employee.my_age) != True:
                        valid = False
                    elif my_validator.val_bmi(employee.my_bmi) != True:
                        valid = False
                    elif my_validator.val_gender(employee.my_gender) != True:
                        valid = False
                    elif my_validator.Validate_Salary(employee.my_salary) != True:
                        valid = False
                    elif my_validator.Validate_Sales(employee.my_sales) != True:
                        valid = False
                    my_employees[employee.my_empid] = employee
                except ValueError:
                    print("There is something fish about the data")
                else:
                    print(employee)
