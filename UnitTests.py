...
class ValidatorTests(unittest.TestCase):
    ...
    #Kate Pham
    def test_val_sale_invalid_type(self):
        val = Validator()
        test_data = "246"
        expected_result = False
        actual_result = val.Validate_Sales(test_data)[0]
        self.assertEqual(actual_result, expected_result, "result should be" + str(expected_result))


    def test_val_sale_valid_type(self):
        val = Validator()
        test_data = 246
        expected_result = True
        actual_result = val.Validate_Sales(test_data)[0]
    ...
    def test_val_salary_invalid_type(self):
        val = Validator()
        test_data = "wa24603"
        expected_result = False
        actual_result = val.Validate_Sales(test_data)[0]
    ...
    def test_val_salary_valid_type(self):
        val = Validator()
        test_data = 24324
        expected_result = True
        actual_result = val.Validate_Sales(test_data)[0]
    ...
    def test_clean_sale_valid_type(self):
        clean = Cleaner()
        test_data = "246"
        expected_result = True
        actual_result = clean.clean_sales(test_data)[0]
        self.assertEqual(actual_result, expected_result, "result should be" + str(expected_result))
