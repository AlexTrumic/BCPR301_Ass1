...
#    graphs = Graph()
    ...
    def write_to_csv_file(self):
        self.my_reader.write_to_csv(self.all_My_Employees)

    def read_csv_file(self):
        self.my_reader.csv_reader(self.all_My_Employees)
    ...
    #Kate Pham
    def create_scatter(self, type):
        self.graphs.create_scatter(type, self.all_My_Employees)
